...
const WORKOUT_PLAN = {
  1: {
    ...
    emoji: "",
    exercises: [
      { id: "bench_press",      name: "Bankdrücken",                        sets: 3, reps: "8–10",  pause: 90  },
      { id: "ohp",              name: "Schulterdrücken",                    sets: 3, reps: "8–10",  pause: 90  },
      { id: "incline_db",       name: "Schrägbankdrücken (Kurzhantel)",     sets: 3, reps: "8–10",  pause: 90  },
      { id: "tricep_pushdown",  name: "Trizepsdrücken (Kabel/Maschine)",    sets: 2, reps: "10–12", pause: 60  },
  ...
  2: {
    ...
    exercises: [
      ...
      { id: "deadlift",         name: "Kreuzheben / Rum. Kreuzheben",       sets: 3, reps: "6–8",   pause: 120 },
      { id: "leg_press",        name: "Beinpresse",                         sets: 3, reps: "10–12", pause: 90  },
      { id: "leg_curl",         name: "Beinbeuger (Maschine)",              sets: 3, reps: "10–12", pause: 90  },
  ...
  3: {
    ...
    emoji: "",
    exercises: [
      { id: "pullup",           name: "Klimmzüge / Latzug (weiter Griff)",  sets: 3, reps: "8–10",  pause: 90  },
      { id: "cable_row",        name: "Vorgebeugtes Rudern (Kabel/LH)",     sets: 3, reps: "8–10",  pause: 90  },
      { id: "lat_close",        name: "Latziehen (enger Griff)",            sets: 3, reps: "8–10",  pause: 90  },
      { id: "bicep_curl",       name: "Bizepscurls (KH oder SZ-Stange)",    sets: 2, reps: "10–12", pause: 60  },
  ...
  4: {
    ...
    emoji: "",
    exercises: [
      { id: "front_squat",      name: "Frontkniebeuge / Ausfallschritte",   sets: 3, reps: "8–10",  pause: 90  },
      { id: "rdl",              name: "Rum. Kreuzheben (Hamstring)",         sets: 3, reps: "8–10",  pause: 90  },
      { id: "leg_ext",          name: "Beinstrecker (Maschine)",            sets: 3, reps: "10–12", pause: 90  },
      { id: "leg_curl2",        name: "Beinbeuger (Maschine)",              sets: 3, reps: "10–12", pause: 90  },
...
function navigate(view, ...args) {
  ...
  else if (view === 'history') renderHistory(args[0], args[1]);
}
    ...
    <div class="screen home-screen">
      <header class="app-header">
        <div class="logo-mark">
          ...
          <span class="logo-text">GymTracker</span>
        </div>
        <h1 class="app-title">Mein Training</h1>
        <div class="header-sub">${formatDate(new Date())}</div>
      </header>
...
async function renderExercise(dayId, exerciseId) {
  ...
  // Auto-set timer to recommended pause for this exercise
...
async function renderHistory(exerciseId, dayId) {
  ...
  app.innerHTML = `
    <div class="screen history-screen">
      <header class="page-header">
        <button class="back-btn" onclick="navigate('exercise', ${dayId ? dayId : 'currentDay'}, '${exerciseId}')">Zurück</button>
        <div class="header-titles">
          <h2 class="page-title">${ex.name}</h2>
